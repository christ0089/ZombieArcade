...
//		Debug.Log ("OnPreRender Camera "+Camera.current.cameraType+ " is in scene view in Unity: " + Application.unityVersion);
...
//			this.shadowMaskMaterial.SetFloat("_GlobalSoftening", Mathf.Max(1e-5f, _globalSoftening));
		...
		Shader.SetGlobalColor("_SFAmbientLight", _ambientLight);
